  ...
  return (
    <div className="space-y-4">
      <div className="flex items-center justify-between">
        <p className="text-sm text-white/40">OC completadas y canceladas — para auditorías</p>
          ...
          <tbody>
            {isLoading ? (
              ...
              <tr key={oc.id} className="border-b border-white/5 hover:bg-white/5 transition-colors">
                ...
                <td className="px-4 py-3 text-white/60">{(oc.lineas || []).map((l: any) => l.sku?.codigo).join(', ')}</td>
